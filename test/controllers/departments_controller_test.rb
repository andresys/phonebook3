...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { email: @department.email, name: @department.name, phone: @department.phone } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { email: @department.email, name: @department.name, phone: @department.phone } }
