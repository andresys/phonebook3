module Settings::ContactSearch
  ...
  included do
    ...
    searchkick index_name: 'phonebook_contacts', mappings: {
      properties: {
        firstname: {
          type: 'keyword',
          fields: {
        ...
        department_sort: { type: 'integer', index: false },
        title_sort: { type: 'integer', index: false },
        phones: {
          type: 'keyword',
          fields: {
            phone: {
    ...
    def search_data
      {
        ...
        department: department&.self_and_ancestors&.pluck(:name) || [],
        title: title&.name,
        slug: slug,
        department_slug: department&.self_and_ancestors&.pluck(:slug) || [],
        department_sort: department&.lft,
        title_sort: title&.position,
