...
$(document).on('turbolinks:load', function() {
  ...
  $("[data-action=add]").removeClass("invisible").on('click', function(e){
    ...
    var control = '<div class="form-row form-group"><div class="col-6"><input type="hidden" name="'+ add_model +'[params][][type]" value="'+ add_type +'"><select name="'+ add_model +'[params][][name]" data-placeholder="'+ add_ph[0] +'" data-tags="true" class="form-control"><option></option></select></div><div class="col-6"><input type="text" name="'+ add_model +'[params][][value]" class="form-control" placeholder="'+ add_ph[1] +'"></div></div>';
